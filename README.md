...
Proyek analisis sentimen ulasan produk skincare menggunakan Python dan TextBlob.
Dibuat sebagai bagian dari portofolio data science.

---

## 🎯 Tujuan
Mengklasifikasikan ulasan pelanggan secara otomatis menjadi **Positif**, **Negatif**, 
atau **Netral** untuk membantu tim marketing memahami persepsi pelanggan terhadap produk.
...
python buat_data.py
python 01_eksplorasi.py
python 02_preprocessing.py
python 03_analisis.py
python 04_visualisasi.py

## 📈 Visualisasi

### Distribusi Sentimen
![Pie Chart](grafik_sentimen_pie.png)

### Sentimen per Produk
![Bar Chart](grafik_sentimen_produk.png)

### Skor Sentimen per Produk
![Skor](grafik_skor_sentimen.png)

### Kata Paling Sering di Ulasan Positif
![Kata Positif](grafik_kata_positif.png)

---

## 👤 Author
**Rio Ramadhan** — Mahasiswa Manajemen Pemasaran yang tertarik di bidang Data Science  
📧 rioramadhan1611@gmail.com. 
🔗 [LinkedIn](https://linkedin.com/in/rioramadhan)
